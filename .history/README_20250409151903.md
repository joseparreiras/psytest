...
For more details, check the documentation [here](https://joseparreiras.github.io/docs/_build/html/index.html) for more details on how to use the package and its methods.
