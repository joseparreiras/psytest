...
A bubble is defined as a period of explosive growth above a unit root in the time series. The PSY test applies a sequence of backward expanding AugmentedDickey Fuller (ADF) tests to the data in order to identify the presence of bubbles. 
