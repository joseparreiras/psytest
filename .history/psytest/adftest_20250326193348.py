...
TStatFunc: TypeAlias = Callable[Concatenate[NumArray, Param], float64]
SimDistFunc: TypeAlias = Callable[Concatenate[int, int, int], NumArray]
...
class ADFtest:
    def __init__(
        self,
        y: NumArray,
        teststat_func: Callable[[NumArray, ...], float64] = adfuller_stat,
