...
@njit(parallel=True)
def bsadfuller_stat(y: NumArray, r0: int, r2_grid: NumArray, kmax: int) -> NumArray:
    """
    ...
    Args:
        y (NumArray): The time series data.
        r0 (int): Initial period to start the test.
        r2_grid (NumArray): The grid of final periods to end the test.
        kmax (int): Maximum lag to use in the test.
