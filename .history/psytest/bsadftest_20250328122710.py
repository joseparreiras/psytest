...
from numpy import float64, inf, empty, int64
...
def __combinations_r2r1__(r2_max: int64, r1_max: int64) -> NDArray[float64]:
    total: int64 = r2_max * r1_max
