...
class PSYBubbles:
    ...
    def find_bubbles(self, alpha: float):
        ...
        bubble_bool: list[bool] = [stat[i] > cval[i][alpha_index] for i in range(len(stat))]bubble_index: list[tuple[int, int | None]] = list(__find_bubble_dates(bubble_bool, self.minlength))
