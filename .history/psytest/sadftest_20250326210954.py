from .adftest import adfuller_stat, ADFtest, NumArray, KMAX
...
@njit(parallel=True)
def sadfuller_asymp_dist(w: NumArray, r0: int, **kwargs) -> float64:
    """
...
def sadfuller_dist(nobs: int, nreps: int, r0: int, **kwargs) -> NumArray:
    """
...
class SADFtest(ADFtest):
    def __init__(self, y: NumArray, kmax: int = KMAX, r0: int | None = None) -> None:
        ...
        """
        r0 = r0 or r0_default(len(y))
        super().__init__(y, sadfuller_stat, sadfuller_dist, kmax=kmax, r0=r0)
