...
def bsadf_stat_all_series(y: NDArray[float64], r0: int, r2_grid: NDArray[int64], kmax: int) -> NDArray[int64]:
    """
...
def __r2r1_combinations__(nobs: int64, r0: int64) -> NDArray[int64]:
    """
    Calculates all the combinations of (r1, r2) for the calcuation of the BSADF test
