...
def sadfuller_dist(nobs: int64, nreps: int64, r0: int64) -> tuple(NDArray[int64], NDArray[float64]):
    ...
    return (arange(nobs-r0+1),  __sadfuller_dist_from_random_walks__(rw, iterator, r0))
...
def bsadf_stat_all_series(
    y: NDArray[float64], r0: int, kmax: int64
    ...
    for i in prange(len(r1r2_grid)):
        r1: int64 = r1r2_grid[i][0]
        r2: int64 = r1r2_grid[i][1]
