from numpy import ceil, cumsum, float64, zeros, log, floor
...
def simulate_markov(nobs: int, p=0.975, beta_list: list[float] = [1.01, 1]) -> tuple[list[float], list[float]]:
