...
gsadf.teststat(r0=r0)
gsadf.critval(nreps = nreps)

%timeit gsadfuller_stat(y, r0, 0)
%timeit new_gsadf(y, r0, 0)

%timeit sadfuller_stat(y, r0, 0)

%timeit bsadfuller_stat(y, r0, 0)